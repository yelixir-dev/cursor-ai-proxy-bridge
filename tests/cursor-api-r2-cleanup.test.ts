...
describe('cursor-api Run cleanup', () => {
  ...
  it('aborts a pending parallel batch, cancels the stream, and surfaces no terminal', async () => {
    ...
    // Then: the stream is ended and cancelled, no terminal event is emitted, and a later
